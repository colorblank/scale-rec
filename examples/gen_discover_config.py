...
DATA_SOURCES: list[ConfigDict] = [
    {
        "name": "request_context",
        "kind": "request",
        "description": "context fields passed by the caller",
    },
    {
    ...
    {
        "name": "item_stats_flink",
        "kind": "flink",
        "description": "nearline item statistics generated by Flink",
    },
    {
        "name": "item_vector_milvus",
        "kind": "milvus",
        "description": "item vector or semantic id lookup",
    },
]
...
def _default_data_source(source: str) -> str:
    if source == "User":
        return "user_profile_hbase"
    if source == "Item":
        return "item_document_es"
    if source == "Context":
...
def _source(
    ...
    *,
    ...
    return {
        "name": name,
        "source": source,
        "data_source": data_source or _default_data_source(source),
        "dtype": dtype,
        "default_val": default_val,
    }


def _with_data_sources(sources: list[SourceDef]) -> list[SourceDef]:
    overrides = {
        "quality_score_label": "item_stats_flink",
        "emb_id": "item_vector_milvus",
        "historical_click_items": "item_vector_milvus",
    }
    result = []
...
def generate_config() -> ConfigDict:
    return {
        ...
        "sources": _with_data_sources(_build_sources()) + LABEL_SOURCES,
...
def generate_user_config() -> ConfigDict:
    ...
    return {
        "version": VERSION,
        "data_sources": DATA_SOURCES,
        "sources": [item_id_src] + user_sources + LABEL_SOURCES,
    }
