...
def test_demo_model_configs_exist_and_are_current():
    model_configs = {
        "demo_finalmlp": EXAMPLES_DIR / "models" / "finalmlp.yaml",
        "demo_dcnv2": EXAMPLES_DIR / "models" / "dcnv2.yaml",
        ...
        "demo_full_mix": EXAMPLES_DIR / "models" / "full_mix.yaml",
