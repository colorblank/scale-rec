...
_MODEL_PARAM_SPECS: dict[str, tuple[set[str], set[str], dict[str, type | tuple[type, ...]]]] = {
    ...
    "dcnv2": (
        _COMMON_MODEL_KEYS | {"cross_layers", "deep_hidden_dims", "shared_bottom_dims"},
        set(),
        {
            "cross_layers": int,
    ...
    "finalmlp": (
        _COMMON_MODEL_KEYS | {"stream_hidden_dims", "gate_hidden_dim", "fusion_hidden_dims"},
        set(),
        {
            "stream_hidden_dims": list,
            "gate_hidden_dim": int,
            "fusion_hidden_dims": list,
            "tasks": list,
            "label_col_map": dict,
            "metrics": dict,
            "output_contract": dict,
    ...
    "esmm": (
        _COMMON_MODEL_KEYS | {"shared_bottom_dims", "task_config"},
        {"task_config"},
        {
            "shared_bottom_dims": list,
            "task_config": dict,
