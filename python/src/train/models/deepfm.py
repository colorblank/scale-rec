...
class DeepFM(nn.Module):
    def __init__(self, features, fm_k, deep_hidden_dims):
        ...
        self.fm_k=fm_k; self.deep=FeatureEmbeddings(features); self.deep_total_dim=self.deep.total_dim
    ...
    def forward(self, x_inputs):
        ...
        second=fm_interaction(stacked); deep_out=self.deep_mlp(self.deep(x_inputs))
