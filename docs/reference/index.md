...
| Reference | Content |
|---|---|
| [HTTP API](../API.md) | HTTP endpoints、请求、响应和错误格式 |
...
| [产物发布与版本管理](../tutorial/08_artifact_publish_and_versioning.md) | run manifest、serving manifest、sha256、model version 和回滚 |
