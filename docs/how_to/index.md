...
| 调整多目标损失权重 | [Model Config Reference](../reference/model_config.md#loss-weighting)、[样本表、标签与任务定义](../tutorial/02_samples_labels_tasks.md) |
...
| 调用 HTTP API | [HTTP API](../API.md) |
| 暴露和采集 Prometheus 指标 | [Prometheus metrics](../METRICS.md) |
...
| 运行 HTTP 压测 | [HTTP 压测报告](../http_benchmark_report.md)、[训练手册](../TRAINING_GUIDE.md#http-压测) |
